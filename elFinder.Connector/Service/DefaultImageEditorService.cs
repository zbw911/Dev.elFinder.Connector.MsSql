...
namespace elFinder.Connector.Service
{
    public class DefaultImageEditorService : IImageEditorService
    {
        ...
        public virtual bool CanGenerateThumbnail(string filePath)
        {
        ...
        public virtual string CreateThumbnail(string sourceImagePath, string destThumbsDir, string thumbFileName,
        ...
        public virtual bool CropImage(string sourceImagePath, Point topLeft, Size newSize)
        {
            try
            {
                string fileExt = Path.GetExtension(sourceImagePath).ToLowerInvariant().Trim('.');
        ...
        public virtual bool ResizeImage(string sourceImagePath, Size newSize)
        {
            try
            {
                string fileExt = Path.GetExtension(sourceImagePath).ToLowerInvariant().Trim('.');
        ...
        public virtual bool RotateImage(string sourceImagePath, int rotationDegree)
        {
            try
            {
                string fileExt = Path.GetExtension(sourceImagePath).ToLowerInvariant().Trim('.');
